          ...
          child: Column(
            ...
            children: [
              ...
              Obx(
                ...
                () => SettingsSwitch(
                  title: "字体描边",
                  value: controller.danmuStrokeWidth.value.toInt() == 0,
                  onChanged: (e) {
                    if (e) {
                      controller.setDanmuStrokeWidth(0);
                    } else {
                      controller.setDanmuStrokeWidth(1);
                    }
                    updateDanmuOption(
                      danmakuController?.option.copyWith(showStroke: e),
                    );
                  },
                ),
              ),
